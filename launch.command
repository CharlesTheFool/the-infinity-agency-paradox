...
# Check for Python in common macOS locations
if command -v python3 &> /dev/null; then
    ...
    echo -e "${GREEN}Found Python $PYTHON_VERSION (Homebrew)${NC}"
elif [ -f "/opt/homebrew/bin/python3" ]; then
    PYTHON_VERSION=$(/opt/homebrew/bin/python3 --version 2>&1 | awk '{print $2}')
    PYTHON_CMD="/opt/homebrew/bin/python3"
    echo -e "${GREEN}Found Python $PYTHON_VERSION (Homebrew ARM)${NC}"
